...
py -m producers.basic_producer_philip
```

Mac/Linux:
```zsh
source .venv/bin/activate
python3 -m producers.basic_producer_philip
```
...
```shell
.venv\Scripts\activate
py -m consumers.basic_consumer_philip.py
```

Mac/Linux:
```zsh
source .venv/bin/activate
python3 -m consumers.basic_consumer_philip.py
```
